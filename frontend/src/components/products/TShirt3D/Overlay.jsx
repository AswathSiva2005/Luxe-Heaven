...
export function Overlay() {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
      <AnimatePresence>
        {snap.intro ? (
          <motion.section key="main" {...config} style={{ position: 'absolute', top: 0, left: 0, display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', height: '100%', width: '100%' }}>
            <div className="section--container">
              ...
              <div className="support--content">
                <motion.div
                  ...
                  <button style={{ background: snap.color, pointerEvents: 'all' }} onClick={() => (state.intro = false)}>
          ...
          <motion.section key="custom" {...config} style={{ position: 'absolute', top: 0, left: 0, display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', height: '100%', width: '100%' }}>
            <Customizer />
          </motion.section>
        )}
      </AnimatePresence>
...
function Customizer() {
  const snap = useSnapshot(state)
  return (
    <div className="customizer" style={{ pointerEvents: 'all' }}>
